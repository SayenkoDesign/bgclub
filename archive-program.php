            ...
            if ( have_posts() ) : ?>
               ...
               <?php
                while ( have_posts() ) :
                    ...
                    printf( '<div class="thumbnail"%s>%s</div><div class="entry-content"><div class="description" data-equalizer-watch>%s</div>%s</div>', $background, $title, $description, $permalink );
